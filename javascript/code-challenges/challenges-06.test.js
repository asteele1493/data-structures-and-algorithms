...
const getNames = (arr) => arr.map(str => str.name.split('').reduce((accumulator, currentValue) => currentValue + accumulator));
...
//modifying the array in place-- use forEach()?

// const appendFirstToLast = (arr) => arr.push(arr.shift());
