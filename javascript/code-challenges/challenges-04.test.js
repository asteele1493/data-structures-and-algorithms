...
------------------------------------------------------------------------------------------------ */
//I was having trouble starting this challenge, but talking it through with Manuch helped me understand the algorithm more.
function upper(str) {
...
const updateAnimal = (arr, callback) => {
  //create a new array
  const newArr = [];
  //using forEach to iterate over the array and modify each element's value
  arr.forEach(elementValue => newArr.push(callback(elementValue)));
  //sorting the elements in the newArr
  newArr.sort();
  //returning array
  return newArr;
...
const sortNames = (arr) => {
  //default sorting method with strings, in ascending order, will return in capital, alphebetical order.
  arr.sort();
  return arr;
};
...
------------------------------------------------------------------------------------------------ */
// Came to this solution using https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/sort
//Using a different comparer function. Also helped to look at objects and how they are used in the sort function.
