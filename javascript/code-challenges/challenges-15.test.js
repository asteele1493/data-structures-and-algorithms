...
Write a function named biggerThanLukne that, given the Star Wars data, below, returns the names of the characters whose mass is greater than Luke's.
...
let biggerThanLuke = (arr) => {
  // Solution code here...
  return arr.sort((a,b) => b.mass - a.mass);
};
